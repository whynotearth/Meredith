...
namespace WhyNotEarth.Meredith.App.Controllers.Api.v0.Salon
{
    ...
    public class ReservationController : ControllerBase
    {
        ...
        public ReservationController(MeredithDbContext meredithDbContext, ReservationService reservationService,
        ...
        public async Task<IActionResult> Reserve(int tenantId, string pageSlug, ReservationModel model)
        {
